...
export BASE_MODEL="${BASE_MODEL:-models/judge-r1-grpo-qwen3-8b}"
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-judge-r1-grpo-eval}"
export RESULT_NAME="${RESULT_NAME:-judge_r1_grpo_results.jsonl}"
